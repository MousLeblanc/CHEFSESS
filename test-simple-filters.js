// test-simple-filters.js
// Test simple des filtres médicaux
...
const testData = {
  ...
  medicalConditions: [], // Pas de conditions médicales pour simplifier
  texture: 'normale',
  useStockOnly: false
};

console.log('🧪 Test simple des filtres (sans restrictions)');
